...
namespace Lykke.Service.UrlShortener
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "UrlShortenerLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.UrlShortenerService.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("UrlShortener", channelOptions =>
                        {
